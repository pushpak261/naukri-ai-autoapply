...
class GmailOTPProvider(IOTPProvider):
    """
    Retrieves OTPs from Gmail using IMAP polling.
    """
    ...
    def _fetch_otp_sync(self) -> str | None:
        """Synchronous implementation of OTP fetching."""
    ...
    async def retrieve_otp(self) -> str | None:
        ...
        return await asyncio.to_thread(self._fetch_otp_sync)
