...
async def config_summary(settings: Settings = Depends(get_app_settings)) -> ConfigSummary:
    return ConfigSummary(
        ...
        strict_policy_mode=settings.application.strict_policy_mode,
        freshness_days=settings.search.freshness,
        min_company_rating=settings.application.min_company_rating,
        role_source="search.keywords",
        experience_source="config_default",
