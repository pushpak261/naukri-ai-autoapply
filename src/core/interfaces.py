...
class IRepository(Protocol):
    ...
    async def get_job_by_naukri_id(self, naukri_job_id: str) -> Any | None: ...
...
class IJobBoardProvider(Protocol):
    """Interface for a Job Board automation provider (e.g. Naukri, LinkedIn)."""
