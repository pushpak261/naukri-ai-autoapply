...
export function Skeleton({ className = '', style }: SkeletonProps) {
  return (
    <div
      ...
      style={{ backgroundColor: 'var(--color-surface-hover)', ...style }}
    />
  );
}
...
export function TableRowSkeleton() {
  return (
    <div className="flex items-center justify-between p-3 rounded-lg border" style={{ backgroundColor: 'var(--color-bg)', borderColor: 'var(--color-border)' }}>
