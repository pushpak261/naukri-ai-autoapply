  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-secondary mt-1">Browse and search agent and terminal log files</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-surface rounded-xl border border-border p-5 lg:col-span-1">
          <h2 className="text-sm font-medium text-secondary mb-3">Log Files</h2>
          <div className="flex items-center gap-2 bg-bg border border-border rounded-lg px-3 py-2 mb-3">
            ...
            <input
              ...
              className="bg-transparent border-none outline-none text-text placeholder:text-muted w-full text-xs"
            />
          </div>
          <div className="space-y-1 max-h-[600px] overflow-y-auto">
            {loading ? (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-text text-xs truncate">{f.name}</p>
              ...
              <div className="text-center py-8 text-muted text-sm">No log files found</div>
            )}
          </div>
        </div>
        ...
        <div className="bg-surface rounded-xl border border-border p-5 lg:col-span-2">
            ...
            {logContent && (
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-bg border border-border text-text text-xs rounded-lg px-2 py-1 outline-none"
                >
          ...
          {contentLoading ? (
            ...
            <pre className="bg-bg border border-border rounded-lg p-4 text-xs font-mono text-secondary overflow-auto max-h-[700px] whitespace-pre-wrap leading-relaxed">
              {filteredContent}
            </pre>
          ) : (
