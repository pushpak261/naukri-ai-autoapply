    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-secondary mt-1">All application attempts ({total} total)</p>
        </div>
      ...
      <div className="flex gap-2 flex-wrap">
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
            statusFilter === '' ? 'bg-primary/10 text-primary border border-primary/30' : 'bg-surface text-secondary border border-border hover:bg-surface-hover'
          }`}
        >
          All
        </button>
      ...
      <div className="bg-surface rounded-xl border border-border overflow-hidden">
        {error ? (
          ...
          <div className="text-center py-16 text-muted">No applications found</div>
        ) : (
